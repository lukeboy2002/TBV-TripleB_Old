<div>
    ...
    <div class="flex justify-between items-center space-x-4 pb-4 pt-2">
        ...
        <div class="pr-2">
            <x-link.btn-primary href="{{ route('admin.permissions.create') }}" class="px-5 py-2.5 text-sm font-medium">
                New permission
            </x-link.btn-primary>
        </div>
    </div>
...
{{--                                         class="px-2.5 py-2.5 text-xs font-medium"--}}
{{--                                         wire:click="setDeleteId({{ $permission->id }})">--}}
{{--                            <i class="fa-solid fa-trash-can"></i>--}}
{{--                        </x-button.danger>--}}
                    </td>
                </tr>
...
{{--                </svg>--}}
{{--                <h3 class="mb-5 text-lg font-normal text-gray-700 dark:text-white">Are you sure you want to delete this permission?</h3>--}}
