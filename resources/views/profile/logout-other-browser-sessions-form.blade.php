<x-section.action>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-button.secondary class="px-3 py-2 text-xs font-medium" wire:click="confirmLogout" wire:loading.attr="disabled">
                Log Out Other Browser Sessions
            </x-button.secondary>

            <x-action-message class="ml-3 flex items-center" on="loggedOut">
